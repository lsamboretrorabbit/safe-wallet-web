...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'MINA{Wallet}'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using {'MINA{Wallet}'}</h4>
    <p>
      When visiting our website or using {'MINA{Wallet}'}, we may collect and process personal data. The data will be
    ...
    <ol start={4}>
      <li>
        ...
        the {'MINA{Wallet}'}, we process your
        <ol>
    ...
    <p>
      In addition, we may take a recording of you while testing {'MINA{Wallet}'} for internal and external use. The
    ...
    <p>
      {'MINA{Wallet}'} mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the {'MINA{Wallet}'} mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`MINA{Wallet}`}. For
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>{'MINA{Wallet} – Privacy policy'}</title>
      </Head>
